          ...
          {items.length === 0 ? (
            ...
            items.map((it) => (
              <div className="cartdrawer__item" key={it.key}>
                <img
                  className="cartdrawer__img"
                  src={it.image}
                  alt={it.title}
                />

                <div className="cartdrawer__info">
                  <div className="cartdrawer__brand">
                    {it.brand}
                  </div>
                  <div className="cartdrawer__name">
                    {it.title}
                  </div>

                  {it.size && (
                    <div className="cartdrawer__meta">
                      Talla: {it.size}
                    </div>
                  )}

                  <div className="cartdrawer__priceRow">
                    <div className="cartdrawer__price">
                      {money(it.price)}
                    </div>
